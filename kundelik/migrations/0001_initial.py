# Generated by Django 5.1.7 on 2025-04-21 18:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254, verbose_name='Электрондық пошта')),
                ...
                ('first_name', models.CharField(max_length=150, verbose_name='Аты')),
        ...
        migrations.AddField(
            model_name='user',
            name='school',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='kundelik.school', verbose_name='Мектеп'),
        ),
        migrations.CreateModel(
            name='Subject',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_number', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Сабақ нөмірі')),
                ('topic', models.CharField(blank=True, max_length=255, verbose_name='Сабақ тақырыбы')),
                ('task', models.TextField(blank=True, verbose_name='Үй тапсырмасы')),
                ('status', models.CharField(choices=[('assigned', 'Берілді'), ('completed', 'Орындалды'), ('not_completed', 'Орындалмады'), ('checked', 'Тексерілді')], default='assigned', max_length=20, verbose_name='Статус')),
                ('school_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to='kundelik.class', verbose_name='Сынып')),
                ('teacher', models.ForeignKey(limit_choices_to={'role__in': ['teacher', 'director', 'admin']}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='schedules_as_teacher', to=settings.AUTH_USER_MODEL, verbose_name='Мұғалім')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('term', models.PositiveSmallIntegerField(null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(4)], verbose_name='Тоқсан')),
        ...
        migrations.AddField(
            model_name='class',
            name='subjects',
            field=models.ManyToManyField(blank=True, related_name='classes_taught_in', to='kundelik.subject', verbose_name='Осы сыныптың пәндері'),
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('grade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students_profiles', to='kundelik.class', verbose_name='Сыныбы')),
            ],
            options={
